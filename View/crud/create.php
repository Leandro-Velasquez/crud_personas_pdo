<div class="absolute top-24 text-center w-full px-2 sm:px-4 sm:py-4 sm:w-3/4 sm:left-1/2 sm:transform sm:-translate-x-1/2 sm:shadow-2xl md:w-3/5 lg:w-3/6">
    ...
    <form class="flex flex-col gap-3" action="<?php echo URL_SITE . 'Persona/store'; ?>" method="POST">
        <div class="flex flex-col gap-2">
            ...
            <input id="nombre" name="nombre" class="border-2 outline-0 p-2" type="text" placeholder="Ingrese su nombre" autocomplete="off">
        </div>
        <div class="flex flex-col gap-2">
            <label class="text-left" for="apellido">Apellido</label>
            <input id="apellido" name="apellido" class="border-2 outline-0 px-2 py-2" type="text" placeholder="Ingrese su apellido" autocomplete="off">
        </div>
        <div class="flex flex-col gap-2">
            <label class="text-left" for="telefono">Telefono</label>
            <input id="telefono" name="telefono" class="border-2 outline-0 px-2 py-2" type="text" placeholder="Ingrese su telefono" autocomplete="off">
        </div>
        <div class="flex flex-col gap-2">
            <label class="text-left" for="email">Email</label>
            <input id="email" name="email" class="border-2 outline-0 px-2 py-2" type="text" placeholder="Ingrese su email" autocomplete="off">
        </div>
